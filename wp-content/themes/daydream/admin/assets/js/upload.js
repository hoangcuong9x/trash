...
jQuery(document).ready(function ($) {
    ...
    jQuery('.dd_metabox_tabs li a').click(function (e) {
        e.preventDefault();
        ...
        jQuery(this).parents('.inside').find('.dd_metabox_tab').removeClass('active').hide();
        jQuery(this).parents('.inside').find('#dd_tab_' + id).addClass('active').fadeIn();
