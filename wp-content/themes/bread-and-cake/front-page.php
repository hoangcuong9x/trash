  ...
  <div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">
        ...
        while ( $query->have_posts() ) : $query->the_post();
          $i++;
          $bread_and_cake_slideno[] = $i;
          $bread_and_cake_slidetitle[] = get_the_title();
		  $bread_and_cake_slidedesc[] = get_the_excerpt();
          $bread_and_cake_slidelink[] = esc_url(get_permalink());
          ?>
        ...
        <?php
        $k = 0;
        foreach( $bread_and_cake_slideno as $bread_and_cake_sln ){ ?>
    <div id="slidecaption<?php echo esc_attr( $bread_and_cake_sln ); ?>" class="nivo-html-caption">
      <div class="top-bar">
        <h2><a href="<?php echo esc_url($bread_and_cake_slidelink[$k] ); ?>"><?php echo esc_html($bread_and_cake_slidetitle[$k] ); ?></a></h2>
        <p><?php echo esc_html($bread_and_cake_slidedesc[$k] ); ?></p>
        <div class="clear"></div>
        <a class="slide-button" href="<?php echo esc_url($bread_and_cake_slidelink[$k] ); ?>">
          <?php echo esc_html(get_theme_mod('slide_text',__('Read More','bread-and-cake')));?>
          </a>
      </div>
    </div>
 	<?php $k++;
